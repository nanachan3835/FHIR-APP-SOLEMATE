...
def toes_remove(foot_matrix, threshold=30, rows_to_check=10):
    """
...
def toes_remain_removes(foot_matrix, start_row=10, end_row=12, connectivity_threshold=7):
...
def compute_arch_index(foot_matrix_processed: np.ndarray):
    ...
    results = {
        "left": {"AI": left_ai, "type": left_type},
        "right": {"AI": right_ai, "type": right_type}
    }
    return results
